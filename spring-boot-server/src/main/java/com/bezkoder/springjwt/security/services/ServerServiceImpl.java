...
public class ServerServiceImpl implements ServerService 
{
    ...
    private String setServerImageUrl() 
    {
        ...
        System.out.println(ServletUriComponentsBuilder.fromCurrentContextPath().path("/api/test/image/" + imageNames[new Random().nextInt(4)]).toUriString());
        return ServletUriComponentsBuilder.fromCurrentContextPath().path("/api/test/image/" + imageNames[new Random().nextInt(4)]).toUriString();
    }
